...
func (m *v2Manager) Set(ctx context.Context, vm *v1beta1.VirtualMachine, r *configs.Resources) error {
	resources := *r
...
func (m *v2Manager) generateDeviceRuleForVM(ctx context.Context, vm *v1beta1.VirtualMachine) ([]*devices.Rule, error) {
